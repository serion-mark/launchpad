...
- 정가로 따로 사면: 크레딧 30,000cr(20k+10k = 149,000+90,000=239,000) + 호스팅(29,000) = 268,000원 + 회의실
- 패키지가 다양한 구성을 한번에 제공하는 편의성
...
- "월 한도 풀로 쓴다"
- 정가로 따로 사면: 크레딧 75,000cr(50k+20k+5k = 249,000+149,000+49,000=447,000) + 호스팅(29,000) + 프리미엄 5회 + 코드팩(990,000) = 1,466,000원+
- 패키지 990,000원 → **코드팩이 사실상 무료 수준!!**
- 2개월 쓰려면? → 다음 달에 한번 더 결제 (크레딧 75,000cr 추가 지급)

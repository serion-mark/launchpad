      ...
      {showTutorial && (
        <div style={{ position: 'fixed', inset: 0, zIndex: 100, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <div style={{ position: 'relative', width: '92%', maxWidth: 560, maxHeight: '85vh', overflow: 'auto', borderRadius: 20, background: 'var(--bg-card)', border: '1px solid var(--border-primary)', padding: '32px 32px 28px', boxShadow: '0 20px 60px rgba(0,0,0,0.3)' }}>
            ...
            {/* 단계별 안내 */}
            {[
              { step: 1, icon: '✏️', title: '편집 모드 켜기', desc: '상단 "편집" 버튼을 누르면 편집 모드가 켜집니다. 미리보기에서 원하는 곳을 클릭하면 바로 수정 가능!' },
              { step: 2, icon: '🎨', title: '클릭으로 글자/색상 수정', desc: '편집 모드에서 텍스트를 클릭하면 글자 내용, 글자색, 배경색을 바로 변경할 수 있습니다.' },
              { step: 3, icon: '🔗', title: '버튼에 기능 부여하기', desc: '버튼을 클릭한 뒤 "버튼에 기능 부여하기"를 누르세요. 예: "회원가입 페이지로 이동하게 만들어줘"' },
              { step: 4, icon: '💬', title: 'AI에게 수정 요청', desc: '더 복잡한 수정은 채팅으로! "메뉴 추가해줘", "페이지 만들어줘" 자연어로 가능합니다.' },
              { step: 5, icon: '🌐', title: '온라인 게시 (중요!)', desc: '수정 후 반드시 "온라인 게시" 버튼을 눌러주세요. 실제 URL에 반영됩니다! 안 누르면 미리보기에서만 보입니다.' },
              { step: 6, icon: '📦', title: '코드 다운로드', desc: '완성된 코드를 ZIP으로 받으세요. 소유권은 100% 고객님 것! 개발자에게 바로 인수인계 가능합니다.' },
            ].map(item => (

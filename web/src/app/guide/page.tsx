...
const FAQ_LIST = [
  ...
  { q: '한 번에 여러 앱을 만들 수 있나요?', a: '프로 플랜(99,000원/월)은 앱 5개, 엔터프라이즈(249,000원/월)는 무제한 앱을 생성할 수 있습니다.' },
  { q: '호스팅 비용은 얼마인가요?', a: '배포 시 월 9,900원입니다. SSL(HTTPS)이 자동 적용되며, 커스텀 도메인 연결도 가능합니다.' },
];
        ...
        {tab === 'manage' && (
          <div className="space-y-8">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              {[
                { icon: '🚀', title: '배포하기', desc: 'Foundry 서버에 앱을 올려 바로 사용합니다.', detail: '월 9,900원 / SSL 자동 / 서브도메인 제공 / 배포 후에도 수정 가능' },

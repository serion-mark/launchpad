...
import { AgentToolExecutor, AGENT_TOOLS } from './agent-tools-v2';
...
import { EventTranslatorService, STAGES } from '../agent-builder/event-translator.service';
import {
  CreditService,
  CREDIT_COSTS,
  classifyIntent,
...
@Injectable()
export class AgentBuilderV2Service {
  private readonly logger = new Logger(AgentBuilderV2Service.name);
